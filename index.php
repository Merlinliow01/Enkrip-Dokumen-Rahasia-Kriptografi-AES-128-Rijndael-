...
<head>
  ...
  <title>
    Implementasi Algoritma AES 128 Bit (RIJNDAEL)
  </title>
...
<body>
  ...
  <style>
    body {
      background-image: url('assets/assets2/img/bg23.JPG');
              ...
              <div class="col-lg">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-1">Login Aplikasi<br><br></h1>
                    <img src="assets/assets2/img/bg1.png" class="mt-2 mb-4" width="100">
                  </div>
                  ...
                  <div class="copyright text-center my-auto">
                    <span>Copyright © Implementasi Algoritma Enkripsi AES 128 Bit pada File Dokumen Rahasia UP2B <?= date('Y'); ?> </span>
                  </div>
