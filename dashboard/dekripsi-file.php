...
<head>
  ...
  <title>Dekripsi - SiEnkrip PLN (Persero) UP2B Sisitem Minahasa</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          <h1 class="h4 mb-0 ml-2 text-gray-800">Dekripsi File</h1>
        ...
        <div class="container-fluid">
          <div class="alert alert-success" role="alert">
            ...
            Implementasi Algoritma Enkripsi AES 128 Bit pada File Digital - Form Dekripsi
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-body">
                  ...
                  $query = $mysqli->query("SELECT * FROM file WHERE id_file='$id_file'");
                  $data2 = mysqli_fetch_array($query);
                  ?>
                  <h3>Dekripsi File <b><?php echo $data2['file_name_finish'] ?></b></h3><br>
                  <form class="form-horizontal" method="post" action="dekripsi-proses.php">
                    <div class="table-responsive">
                      <table class="table striped">
                        ...
                        <tr>
                          ...
                          <td>:</td>
                          <td><?php echo date('d-m-Y / H:i:s', strtotime($data2['tgl_upload'])) ?></td>
                        </tr>
                        <tr>
                          <td>Keterangan</td>
                          <td>:</td>
                        ...
                        <tr>
                          <td>Masukkan Kunci untuk Dekripsi</td>
                          <td>:</td>
                          <td>
                            <div class="col-md-6">
                              ...
                              <input type="submit" name="dekripsi_now" value="Dekripsi File" class="form-control btn btn-primary">
                            </div>
                          </td>
                        </tr>
                      </table>
