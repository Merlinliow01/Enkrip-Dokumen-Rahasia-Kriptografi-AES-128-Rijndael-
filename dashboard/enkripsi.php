...
<head>
  ...
  <title>Enkripsi - Implementasi Algoritma Enkripsi AES 128 Bit pada File Digital UP2B </title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          <h1 class="h4 mb-0 ml-2 text-gray-800">Enkripsi - Implementasi Algoritma Enkripsi AES 128 Bit pada File Digital UP2B</h1>
        ...
        <div class="container-fluid">
          <div class="alert alert-success" role="alert">
            ...
            Implementasi Algoritma Enkripsi AES 128 Bit pada File Digital UP2B - Form Enkripsi
          </div>
          <div class="row">
            <div class="col-md-6">
