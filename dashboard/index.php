...
<head>
  ...
  <title>Implementasi AES 128 Bit Pada File Dokumen Rahasia PLN UP2B Sistem Minahasa</title>
  <link rel="icon" href="../assets/assets2/img/logopln.png">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../dashboard/index.php">
        <div class="sidebar-brand-icon">
          <img src="../assets/assets2/img/logopln.png" width="35" height="35">
        </div>
        <div class="sidebar-brand-text mx-3">SiEnkrip</div>
      </a>
      <!-- Divider -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          <h1 class="h4 mb-0 ml-2 text-gray-800">Implementasi Algoritma AES 128 Bit pada File Dokumen Rahasia PLN UP2B Sistem Minahasa</h1>
        ...
        <div class="container-fluid">
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-md font-weight-bold text-primary text-uppercase mb-1">
                        User</div>
                      <?php
                      $query = $mysqli->query("SELECT count(*) totaluser FROM users");
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-md font-weight-bold text-info text-uppercase mb-1">Dekripsi
                      </div>
                      <?php
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <h5>Implementasi Metode Enkripsi AES 128 Bit pada File Dokumen Rahasia</h5>
              <h6> PLN (Persero) UP2B SIstem Minahasa </h6>
              <br>
              <p>Implementasi Algoritma Enkripsi AES 128 Bit pada File Digital yang bersifat RAHASIA (PLN (Persero) UP2B Sistem Minahasa), bertujuan
                                    untuk meminimalisir penyalahgunaan data rahasia oleh pihak yang tidak bertanggungjawab. Algoritma Enkripsi
                                    AES 128 Bit digunakan untuk mengubah file digital menjadi file ciphertext atau file yang sulit untuk dimengerti makna dan isinya.
              ...
              <a target="_blank" rel="nofollow" href="enkripsi.php">Enkripsi File Sekarang &rarr;</a>
            </div>
          </div>
        </div>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright 2025 &copy; Implementasi Algoritma Enkripsi AES 128 Bit pada File Dokumen Rahasia UP2B</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
