        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    <h1 class="h4 mb-0 ml-2 text-gray-800">Bantuan - Implementasi Algoritma Enkripsi AES 128 Bit pada File Dokumen Rahasia UP2B</h1>
                ...
                <div class="container-fluid">
                    <div class="alert alert-success" role="alert">
                       ...
                       Implementasi Algoritma Enkripsi AES 128 Bit pada File Digital- Bantuan
                    </div>
                    <div class="col-md-12">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="card-body">
                                    <h5>Implementasi Algoritma Enkripsi AES 128 Bit pada File Dokumen Rahasia</h5>
