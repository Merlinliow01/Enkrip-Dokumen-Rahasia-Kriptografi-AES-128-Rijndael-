        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    <h1 class="h4 mb-0 ml-2 text-gray-800">Enkripsi - Implementasi Algoritma Enkripsi AES 128 Bit pada File Dokumen Rahasia UP2B</h1>
                ...
                <div class="container-fluid">
                    <div class="alert alert-success" role="alert">
                        ...
                        Implementasi Algoritma Enkripsi AES 128 Bit pada File Dokumen Rahasia UP2B - Proses Enkripsi
                    </div>
                    <a href="file.php" class="btn btn-success mb-2"><i class="fas fa-arrow-right mr-2"></i>Lihat Hasil</a>
                    <div class="col-md-12">
